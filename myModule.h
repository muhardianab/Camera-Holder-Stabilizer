...
// Pengaktifan fitur lagu (buzzer) pada board kontroler, isi 1 jika diaktifkan, isi 0 jika tidak
    ...
    #define UseServo1                   1           // Mengaktifkan Servo 1 ?
    #define UseServo2                   1           // Mengaktifkan Servo 2 ?
    #define UseServo3                   1           // Mengaktifkan Servo 3 ?
    #define UseServo4                   1           // Mengaktifkan Servo 4 ?
    #define UseServo5                   1           // Mengaktifkan Servo 5 ?
    // servo 6, 7 dan 8 secara default aktif dengan PWM hardware dari board kontroler (OCR3x)
        ...
        #define ImuFilter               DMP
            ...
            #define UseAcceleroFiFo     1           // apakah data Accelerometer dikeluarkan pada FiFo
        #endif // ImuFilter
